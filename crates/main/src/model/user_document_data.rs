...
impl UserDocumentData {
    ...
    pub(crate) fn into_user(self) -> anyhow::Result<crate::model::User> {
        Ok(crate::model::User::new(
            crate::model::DateTime::from_rfc3339(&self.created_at)?,
            self.google_user_id.parse::<crate::model::GoogleUserId>()?,
